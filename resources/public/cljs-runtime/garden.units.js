 ...
 */
garden.units.convert = (function garden$units$convert(p__27138,right){
var map__27139 = p__27138;
var map__27139__$1 = cljs.core.__destructure_map(map__27139);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27139__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27139__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__27140 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27143__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__27144 = u(y);
var map__27144__$1 = cljs.core.__destructure_map(map__27144);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27144__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
while (G__27155__i < G__27155__a.length) {G__27155__a[G__27155__i] = arguments[G__27155__i + 2]; ++G__27155__i;}
  more = new cljs.core.IndexedSeq(G__27155__a,0,null);
} 
...
G__27157 = new cljs.core.IndexedSeq(G__27158__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__27157);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27145__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__27146 = u(y);
var map__27146__$1 = cljs.core.__destructure_map(map__27146);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27146__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
while (G__27160__i < G__27160__a.length) {G__27160__a[G__27160__i] = arguments[G__27160__i + 2]; ++G__27160__i;}
  more = new cljs.core.IndexedSeq(G__27160__a,0,null);
} 
...
G__27162 = new cljs.core.IndexedSeq(G__27163__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__27162);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27147__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__27148 = u(y);
var map__27148__$1 = cljs.core.__destructure_map(map__27148);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27148__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__27164__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__27165__i = 0, G__27165__a = new Array(arguments.length -  2);
while (G__27165__i < G__27165__a.length) {G__27165__a[G__27165__i] = arguments[G__27165__i + 2]; ++G__27165__i;}
  more = new cljs.core.IndexedSeq(G__27165__a,0,null);
} 
...
G__27168 = new cljs.core.IndexedSeq(G__27169__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__27168);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27149__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__27150 = u(y);
var map__27150__$1 = cljs.core.__destructure_map(map__27150);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27150__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__27170__delegate = function (x,y,more){
...
var G__27170 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__27171__i = 0, G__27171__a = new Array(arguments.length -  2);
while (G__27171__i < G__27171__a.length) {G__27171__a[G__27171__i] = arguments[G__27171__i + 2]; ++G__27171__i;}
  more = new cljs.core.IndexedSeq(G__27171__a,0,null);
} 
return G__27170__delegate.call(this,x,y,more);};
G__27170.cljs$lang$maxFixedArity = 2;
...
return G__27170__delegate(x,y,more);
});
...
var G__27173 = null;
if (arguments.length > 2) {
var G__27174__i = 0, G__27174__a = new Array(arguments.length -  2);
while (G__27174__i < G__27174__a.length) {G__27174__a[G__27174__i] = arguments[G__27174__i + 2]; ++G__27174__i;}
G__27173 = new cljs.core.IndexedSeq(G__27174__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__27173);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
