...
var i_46169 = (0);
while(true){
if((i_46169 < arr.length)){
(arr[i_46169] = null);

var G__46170 = (i_46169 + (1));
i_46169 = G__46170;
continue;
} else {
}
...
var i_46184 = (self__.level + (1));
while(true){
if((i_46184 <= (new_level + (1)))){
(update[i_46184] = self__.header);

var G__46185 = (i_46184 + (1));
i_46184 = G__46185;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_46187 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_46187[i]));
} else {
x__$2.forward.push((((i < links_46187.length))?(links_46187[i]):null));
}

if((i < links_46187.length)){
(links_46187[i] = x__$2);
} else {
links_46187.push(x__$2);
}
...
var i_46192 = (0);
while(true){
if((i_46192 <= self__.level)){
var links_46193 = (update[i_46192]).forward;
if((x__$1 === (((i_46192 < links_46193.length))?(links_46193[i_46192]):null))){
(links_46193[i_46192] = (x__$1.forward[i_46192]));

var G__46195 = (i_46192 + (1));
i_46192 = G__46195;
continue;
} else {
var G__46196 = (i_46192 + (1));
i_46192 = G__46196;
continue;
}
} else {
...
var G__46202 = nx;
var G__46203 = (level__$1 - (1));
x = G__46202;
level__$1 = G__46203;
continue;
} else {
var G__46205 = x;
var G__46206 = (level__$1 - (1));
x = G__46205;
level__$1 = G__46206;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__46215 = nx;
var G__46216 = (level__$1 - (1));
x = G__46215;
level__$1 = G__46216;
continue;
} else {
var G__46217 = x;
var G__46218 = (level__$1 - (1));
x = G__46217;
level__$1 = G__46218;
continue;
}
