...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_46131 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_46131(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_46132 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_46132(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46134 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46134(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46136 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46136(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46138 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46138(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46141 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46141(reader);
}
});
...
var G__46225 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__46226 = s.append(c);
c = G__46225;
s = G__46226;
continue;
}
