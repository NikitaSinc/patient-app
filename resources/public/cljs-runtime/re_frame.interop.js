...
return [(function (){var pred__53553 = cljs.core.instance_QMARK_;
var expr__53554 = reactive_val;
if(cljs.core.truth_((pred__53553.cljs$core$IFn$_invoke$arity$2 ? pred__53553.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__53554) : pred__53553.call(null,reagent.ratom.RAtom,expr__53554)))){
return "ra";
} else {
if(cljs.core.truth_((pred__53553.cljs$core$IFn$_invoke$arity$2 ? pred__53553.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__53554) : pred__53553.call(null,reagent.ratom.RCursor,expr__53554)))){
return "rc";
} else {
if(cljs.core.truth_((pred__53553.cljs$core$IFn$_invoke$arity$2 ? pred__53553.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__53554) : pred__53553.call(null,reagent.ratom.Reaction,expr__53554)))){
return "rx";
} else {
if(cljs.core.truth_((pred__53553.cljs$core$IFn$_invoke$arity$2 ? pred__53553.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__53554) : pred__53553.call(null,reagent.ratom.Track,expr__53554)))){
return "tr";
} else {
return "other";
}
