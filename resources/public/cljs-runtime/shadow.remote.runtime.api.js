...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46276 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46276(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_46290 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_46290(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_46294 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_46294(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_46301 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_46301(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46303 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46303(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46304 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46304(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__46266,callback){
var map__46267 = p__46266;
var map__46267__$1 = cljs.core.__destructure_map(map__46267);
var input = map__46267__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46267__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46267__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
