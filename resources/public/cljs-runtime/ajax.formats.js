...
var G__27869 = request;
var G__27870 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__27869,G__27870) : ajax.formats.get_format.call(null,G__27869,G__27870));
} else {
...
return cljs.core.some((function (p1__27882_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__27882_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__27884){
var map__27885 = p__27884;
var map__27885__$1 = cljs.core.__destructure_map(map__27885);
var request = map__27885__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27885__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__27888 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27888.cljs$core$IFn$_invoke$arity$1 ? fexpr__27888.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27888.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__27890){
var map__27891 = p__27890;
var map__27891__$1 = cljs.core.__destructure_map(map__27891);
var request = map__27891__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27891__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__27889_SHARP_){
return ajax.formats.get_accept_entries(request,p1__27889_SHARP_);
