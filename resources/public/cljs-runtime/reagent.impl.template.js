...
var G__53846 = o;
reagent.impl.template.goog$module$goog$object.set(G__53846,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__54035__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54035 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54036__i = 0, G__54036__a = new Array(arguments.length -  0);
while (G__54036__i < G__54036__a.length) {G__54036__a[G__54036__i] = arguments[G__54036__i + 0]; ++G__54036__i;}
  args = new cljs.core.IndexedSeq(G__54036__a,0,null);
} 
return G__54035__delegate.call(this,args);};
G__54035.cljs$lang$maxFixedArity = 0;
G__54035.cljs$lang$applyTo = (function (arglist__54037){
var args = cljs.core.seq(arglist__54037);
return G__54035__delegate(args);
});
G__54035.cljs$core$IFn$_invoke$arity$variadic = G__54035__delegate;
return G__54035;
})()
;
} else {
...
var G__53891 = o;
reagent.impl.template.goog$module$goog$object.set(G__53891,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__54041__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54041 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54042__i = 0, G__54042__a = new Array(arguments.length -  0);
while (G__54042__i < G__54042__a.length) {G__54042__a[G__54042__i] = arguments[G__54042__i + 0]; ++G__54042__i;}
  args = new cljs.core.IndexedSeq(G__54042__a,0,null);
} 
return G__54041__delegate.call(this,args);};
G__54041.cljs$lang$maxFixedArity = 0;
G__54041.cljs$lang$applyTo = (function (arglist__54043){
var args = cljs.core.seq(arglist__54043);
return G__54041__delegate(args);
});
G__54041.cljs$core$IFn$_invoke$arity$variadic = G__54041__delegate;
return G__54041;
})()
;
} else {
...
var G__53902 = props;
var G__53902__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53902,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53902);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53902__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53905 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53905,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53905;
}
})(),id_class);
...
var G__53906 = (cljs.core.count(argv) - first_child);
switch (G__53906) {
case (0):
...
var vec__53918 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53918,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53918,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53918,(2),null);
...
var temp__5808__auto___54054 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___54054 == null)){
} else {
var key_54055 = temp__5808__auto___54054;
(jsprops.key = key_54055);
}
...
var temp__5808__auto___54058 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___54058 == null)){
} else {
var key_54059 = temp__5808__auto___54058;
(jsprops.key = key_54059);
}
...
var temp__5808__auto___54063 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___54063 == null)){
} else {
var key_54064 = temp__5808__auto___54063;
(jsprops.key = key_54064);
}
...
var temp__5808__auto___54066 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___54066 == null)){
} else {
var key_54068 = temp__5808__auto___54066;
(jsprops.key = key_54068);
}
...
var temp__5808__auto___54070 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___54070 == null)){
} else {
var key_54071 = temp__5808__auto___54070;
(jsprops.key = key_54071);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53962_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__53962_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__53965 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53965,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53965,(1),null);
...
break;
default:
var G__54073 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__54074 = compiler;
v = G__54073;
compiler = G__54074;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template54006 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template54006 = (function (opts,id,fn_to_element,parse_fn,meta54007){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta54007 = meta54007;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template54006.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_54008,meta54007__$1){
var self__ = this;
var _54008__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template54006(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta54007__$1));
}));

(reagent.impl.template.t_reagent$impl$template54006.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_54008){
var self__ = this;
var _54008__$1 = this;
return self__.meta54007;
}));

(reagent.impl.template.t_reagent$impl$template54006.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template54006.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template54006.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template54006.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template54006.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template54006.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta54007","meta54007",-1768972297,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template54006.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template54006.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template54006");

(reagent.impl.template.t_reagent$impl$template54006.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template54006");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template54006.
 */
reagent.impl.template.__GT_t_reagent$impl$template54006 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template54006(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54007){
return (new reagent.impl.template.t_reagent$impl$template54006(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54007));
});

}

return (new reagent.impl.template.t_reagent$impl$template54006(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
