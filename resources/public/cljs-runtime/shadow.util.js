...
var len__5769__auto___46006 = arguments.length;
var i__5770__auto___46007 = (0);
while(true){
if((i__5770__auto___46007 < len__5769__auto___46006)){
args_arr__5794__auto__.push((arguments[i__5770__auto___46007]));

var G__46008 = (i__5770__auto___46007 + (1));
i__5770__auto___46007 = G__46008;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq45969){
...
var G__45973 = cljs.core.first(seq45969__$3);
var seq45969__$4 = cljs.core.next(seq45969__$3);
var G__45974 = cljs.core.first(seq45969__$4);
var seq45969__$5 = cljs.core.next(seq45969__$4);
var G__45975 = cljs.core.first(seq45969__$5);
var seq45969__$6 = cljs.core.next(seq45969__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45970,G__45971,G__45972,G__45973,G__45974,G__45975,seq45969__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__45988){
var vec__45990 = p__45988;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45990,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45990,(1),null);
