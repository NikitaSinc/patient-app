...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_45742 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_45742(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_45743 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_45743(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_45744 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_45744(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_45746 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_45746(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_45748 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_45748(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_45749 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_45749(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_45751 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_45751(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_45753 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_45753(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_45754 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_45754(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_45755 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_45755(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_45756 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_45756(b);
}
});
