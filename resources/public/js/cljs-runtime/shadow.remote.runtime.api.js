...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_37236 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_37236(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_37238 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_37238(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_37239 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_37239(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_37241 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_37241(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_37246 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_37246(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37256 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37256(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__37222,callback){
var map__37223 = p__37222;
var map__37223__$1 = cljs.core.__destructure_map(map__37223);
var input = map__37223__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37223__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37223__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
