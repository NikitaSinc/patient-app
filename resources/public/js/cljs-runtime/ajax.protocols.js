...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_47110 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_47110(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_47111 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_47111(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_47115 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_47115(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_47116 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_47116(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_47119 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_47119(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_47121 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_47121(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_47122 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_47122(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_47123 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_47123(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_47124 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_47124(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_47125 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_47125(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k47064,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__47068 = k47064;
var G__47068__$1 = (((G__47068 instanceof cljs.core.Keyword))?G__47068.fqn:null);
switch (G__47068__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k47064,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__47069){
var vec__47070 = p__47069;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47070,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47070,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__47063){
var self__ = this;
var G__47063__$1 = this;
return (new cljs.core.RecordIter((0),G__47063__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this47065,other47066){
var self__ = this;
var this47065__$1 = this;
return (((!((other47066 == null)))) && ((((this47065__$1.constructor === other47066.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47065__$1.status,other47066.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47065__$1.body,other47066.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47065__$1.status_text,other47066.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47065__$1.headers,other47066.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47065__$1.was_aborted,other47066.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this47065__$1.__extmap,other47066.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k47064){
var self__ = this;
var this__5350__auto____$1 = this;
var G__47092 = k47064;
var G__47092__$1 = (((G__47092 instanceof cljs.core.Keyword))?G__47092.fqn:null);
switch (G__47092__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k47064);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__47063){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__47094 = cljs.core.keyword_identical_QMARK_;
var expr__47095 = k__5352__auto__;
if(cljs.core.truth_((pred__47094.cljs$core$IFn$_invoke$arity$2 ? pred__47094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__47095) : pred__47094.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__47095)))){
return (new ajax.protocols.Response(G__47063,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47094.cljs$core$IFn$_invoke$arity$2 ? pred__47094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__47095) : pred__47094.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__47095)))){
return (new ajax.protocols.Response(self__.status,G__47063,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47094.cljs$core$IFn$_invoke$arity$2 ? pred__47094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__47095) : pred__47094.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__47095)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__47063,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47094.cljs$core$IFn$_invoke$arity$2 ? pred__47094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__47095) : pred__47094.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__47095)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__47063,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__47094.cljs$core$IFn$_invoke$arity$2 ? pred__47094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__47095) : pred__47094.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__47095)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__47063,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__47063),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__47063){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__47063,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__47067){
var extmap__5385__auto__ = (function (){var G__47105 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__47067,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__47067)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__47105);
} else {
return G__47105;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__47067),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__47067),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__47067),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__47067),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__47067),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
