...
var G__50630 = Object.getPrototypeOf(obj__$1);
var G__50631 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(protos,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"obj","obj",981763962),obj__$1,new cljs.core.Keyword(null,"props","props",453281727),cider.nrepl.inlined_deps.suitable.v0v4v1.suitable.js_introspection.own_property_descriptors(obj__$1)], null));
obj__$1 = G__50630;
protos = G__50631;
continue;
} else {
...
var iter__5523__auto__ = (function cider$nrepl$inlined_deps$suitable$v0v4v1$suitable$js_introspection$iter__50618(s__50619){
return (new cljs.core.LazySeq(null,(function (){
var s__50619__$1 = s__50619;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__50619__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var vec__50624 = cljs.core.first(xs__6360__auto__);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50624,(0),null);
var map__50627 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50624,(1),null);
var map__50627__$1 = cljs.core.__destructure_map(map__50627);
var _obj = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50627__$1,new cljs.core.Keyword(null,"_obj","_obj",-592966725));
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50627__$1,new cljs.core.Keyword(null,"props","props",453281727));
var iterys__5519__auto__ = ((function (s__50619__$1,vec__50624,i,map__50627,map__50627__$1,_obj,props,xs__6360__auto__,temp__5804__auto__,seen){
return (function cider$nrepl$inlined_deps$suitable$v0v4v1$suitable$js_introspection$iter__50618_$_iter__50620(s__50621){
return (new cljs.core.LazySeq(null,((function (s__50619__$1,vec__50624,i,map__50627,map__50627__$1,_obj,props,xs__6360__auto__,temp__5804__auto__,seen){
return (function (){
var s__50621__$1 = s__50621;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__50621__$1);
if(temp__5804__auto____$1){
var s__50621__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__50621__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__50621__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__50623 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__50622 = (0);
while(true){
if((i__50622 < size__5522__auto__)){
var key = cljs.core._nth(c__5521__auto__,i__50622);
...
cljs.core.chunk_append(b__50623,(function (){var prop = cider.nrepl.inlined_deps.suitable.v0v4v1.suitable.js_introspection.goog$module$goog$object.get(props,key);
...
}catch (e50628){if((e50628 instanceof Error)){
var _e = e50628;
return "var";
} else {
throw e50628;
...
var G__50633 = (i__50622 + (1));
i__50622 = G__50633;
continue;
} else {
var G__50634 = (i__50622 + (1));
i__50622 = G__50634;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50623),cider$nrepl$inlined_deps$suitable$v0v4v1$suitable$js_introspection$iter__50618_$_iter__50620(cljs.core.chunk_rest(s__50621__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50623),null);
}
} else {
var key = cljs.core.first(s__50621__$2);
if(((cljs.core.not(cljs.core.get.cljs$core$IFn$_invoke$arity$2(seen,key))) && (((cljs.core.empty_QMARK_(prefix)) || (clojure.string.starts_with_QMARK_(key,prefix)))))){
...
}catch (e50629){if((e50629 instanceof Error)){
var _e = e50629;
return "var";
} else {
throw e50629;
...
})(),cider$nrepl$inlined_deps$suitable$v0v4v1$suitable$js_introspection$iter__50618_$_iter__50620(cljs.core.rest(s__50621__$2)));
} else {
var G__50635 = cljs.core.rest(s__50621__$2);
s__50621__$1 = G__50635;
continue;
}
}
} else {
...
});})(s__50619__$1,vec__50624,i,map__50627,map__50627__$1,_obj,props,xs__6360__auto__,temp__5804__auto__,seen))
,null,null));
});})(s__50619__$1,vec__50624,i,map__50627,map__50627__$1,_obj,props,xs__6360__auto__,temp__5804__auto__,seen))
;
var fs__5520__auto__ = cljs.core.seq(iterys__5519__auto__(cljs.core.js_keys(props)));
if(fs__5520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5520__auto__,cider$nrepl$inlined_deps$suitable$v0v4v1$suitable$js_introspection$iter__50618(cljs.core.rest(s__50619__$1)));
} else {
var G__50636 = cljs.core.rest(s__50619__$1);
s__50619__$1 = G__50636;
continue;
}
} else {
return null;
