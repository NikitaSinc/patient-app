 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__45880){
var vec__45881 = p__45880;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45881,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45881,(1),null);
return (function (s){
...
var len__5769__auto___45939 = arguments.length;
var i__5770__auto___45940 = (0);
while(true){
if((i__5770__auto___45940 < len__5769__auto___45939)){
args__5775__auto__.push((arguments[i__5770__auto___45940]));

var G__45942 = (i__5770__auto___45940 + (1));
i__5770__auto___45940 = G__45942;
continue;
} else {
}
break;
...
return (p1__45886_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__45886_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__45886_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq45887){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45887));
}));
...
var map__45930 = temp__5802__auto__;
var map__45930__$1 = cljs.core.__destructure_map(map__45930);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45930__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45930__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45930__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__45946 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__45947 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__45932 = tag;
