...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_35015 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_35015(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_35021 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_35021(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_35029 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_35029(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_35052 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_35052(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_35059 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_35059(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_35063 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_35063(reader);
}
});
...
var G__35200 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__35201 = s.append(c);
c = G__35200;
s = G__35201;
continue;
}
