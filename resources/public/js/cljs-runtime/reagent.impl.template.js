...
var G__44640 = o;
reagent.impl.template.goog$module$goog$object.set(G__44640,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__44971__delegate = function (args){
...
while (G__44972__i < G__44972__a.length) {G__44972__a[G__44972__i] = arguments[G__44972__i + 0]; ++G__44972__i;}
  args = new cljs.core.IndexedSeq(G__44972__a,0,null);
} 
return G__44971__delegate.call(this,args);};
G__44971.cljs$lang$maxFixedArity = 0;
G__44971.cljs$lang$applyTo = (function (arglist__44973){
var args = cljs.core.seq(arglist__44973);
return G__44971__delegate(args);
});
...
var G__44643 = o;
reagent.impl.template.goog$module$goog$object.set(G__44643,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__44974__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__44974 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__44974__delegate.call(this,args);};
G__44974.cljs$lang$maxFixedArity = 0;
G__44974.cljs$lang$applyTo = (function (arglist__44976){
var args = cljs.core.seq(arglist__44976);
return G__44974__delegate(args);
});
G__44974.cljs$core$IFn$_invoke$arity$variadic = G__44974__delegate;
return G__44974;
})()
;
} else {
...
var G__44648 = props;
var G__44648__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44648,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44648);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44648__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__44653 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44653,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__44653;
}
})(),id_class);
...
var G__44658 = (cljs.core.count(argv) - first_child);
switch (G__44658) {
case (0):
...
var vec__44661 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44661,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44661,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44661,(2),null);
...
var temp__5808__auto___44978 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___44978 == null)){
} else {
var key_44979 = temp__5808__auto___44978;
(jsprops.key = key_44979);
}
...
var temp__5808__auto___44980 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___44980 == null)){
} else {
var key_44981 = temp__5808__auto___44980;
(jsprops.key = key_44981);
}
...
var temp__5808__auto___44982 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___44982 == null)){
} else {
var key_44983 = temp__5808__auto___44982;
(jsprops.key = key_44983);
}
...
var temp__5808__auto___44984 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___44984 == null)){
} else {
var key_44985 = temp__5808__auto___44984;
(jsprops.key = key_44985);
}
...
var temp__5808__auto___44988 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___44988 == null)){
} else {
var key_44989 = temp__5808__auto___44988;
(jsprops.key = key_44989);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44718_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__44718_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__44736 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44736,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44736,(1),null);
...
break;
default:
var G__44999 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__45000 = compiler;
v = G__44999;
compiler = G__45000;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template44909 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template44909 = (function (opts,id,fn_to_element,parse_fn,meta44910){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template44909.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_44911,meta44910__$1){
var self__ = this;
var _44911__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template44909(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta44910__$1));
}));

(reagent.impl.template.t_reagent$impl$template44909.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_44911){
var self__ = this;
var _44911__$1 = this;
return self__.meta44910;
}));

(reagent.impl.template.t_reagent$impl$template44909.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template44909.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template44909.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template44909.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template44909.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template44909.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta44910","meta44910",1721599324,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template44909.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template44909.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template44909");

(reagent.impl.template.t_reagent$impl$template44909.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template44909");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template44909.
 */
reagent.impl.template.__GT_t_reagent$impl$template44909 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template44909(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta44910){
return (new reagent.impl.template.t_reagent$impl$template44909(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta44910));
});

}

return (new reagent.impl.template.t_reagent$impl$template44909(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
