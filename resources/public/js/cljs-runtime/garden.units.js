 ...
 */
garden.units.convert = (function garden$units$convert(p__46668,right){
var map__46669 = p__46668;
var map__46669__$1 = cljs.core.__destructure_map(map__46669);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46669__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46669__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__46675 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46675,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46675,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46675,(2),null);
...
var map__46687 = u(x);
var map__46687__$1 = cljs.core.__destructure_map(map__46687);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46687__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46688 = u(y);
var map__46688__$1 = cljs.core.__destructure_map(map__46688);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46688__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__46815__delegate = function (x,y,more){
...
var G__46815 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46817__i = 0, G__46817__a = new Array(arguments.length -  2);
while (G__46817__i < G__46817__a.length) {G__46817__a[G__46817__i] = arguments[G__46817__i + 2]; ++G__46817__i;}
  more = new cljs.core.IndexedSeq(G__46817__a,0,null);
} 
return G__46815__delegate.call(this,x,y,more);};
G__46815.cljs$lang$maxFixedArity = 2;
G__46815.cljs$lang$applyTo = (function (arglist__46818){
var x = cljs.core.first(arglist__46818);
arglist__46818 = cljs.core.next(arglist__46818);
var y = cljs.core.first(arglist__46818);
var more = cljs.core.rest(arglist__46818);
return G__46815__delegate(x,y,more);
});
...
var G__46819 = null;
if (arguments.length > 2) {
var G__46820__i = 0, G__46820__a = new Array(arguments.length -  2);
while (G__46820__i < G__46820__a.length) {G__46820__a[G__46820__i] = arguments[G__46820__i + 2]; ++G__46820__i;}
G__46819 = new cljs.core.IndexedSeq(G__46820__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46819);
}
...
var map__46689 = u(x);
var map__46689__$1 = cljs.core.__destructure_map(map__46689);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46689__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46690 = u(y);
var map__46690__$1 = cljs.core.__destructure_map(map__46690);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46690__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__46826__delegate = function (x,y,more){
...
var G__46826 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46827__i = 0, G__46827__a = new Array(arguments.length -  2);
while (G__46827__i < G__46827__a.length) {G__46827__a[G__46827__i] = arguments[G__46827__i + 2]; ++G__46827__i;}
  more = new cljs.core.IndexedSeq(G__46827__a,0,null);
} 
return G__46826__delegate.call(this,x,y,more);};
G__46826.cljs$lang$maxFixedArity = 2;
G__46826.cljs$lang$applyTo = (function (arglist__46828){
var x = cljs.core.first(arglist__46828);
arglist__46828 = cljs.core.next(arglist__46828);
var y = cljs.core.first(arglist__46828);
var more = cljs.core.rest(arglist__46828);
return G__46826__delegate(x,y,more);
});
...
var G__46831 = null;
if (arguments.length > 2) {
var G__46832__i = 0, G__46832__a = new Array(arguments.length -  2);
while (G__46832__i < G__46832__a.length) {G__46832__a[G__46832__i] = arguments[G__46832__i + 2]; ++G__46832__i;}
G__46831 = new cljs.core.IndexedSeq(G__46832__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46831);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__46695 = u(x);
var map__46695__$1 = cljs.core.__destructure_map(map__46695);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46695__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46696 = u(y);
var map__46696__$1 = cljs.core.__destructure_map(map__46696);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46696__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__46836__delegate = function (x,y,more){
...
var G__46836 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46839__i = 0, G__46839__a = new Array(arguments.length -  2);
while (G__46839__i < G__46839__a.length) {G__46839__a[G__46839__i] = arguments[G__46839__i + 2]; ++G__46839__i;}
  more = new cljs.core.IndexedSeq(G__46839__a,0,null);
} 
return G__46836__delegate.call(this,x,y,more);};
G__46836.cljs$lang$maxFixedArity = 2;
G__46836.cljs$lang$applyTo = (function (arglist__46840){
var x = cljs.core.first(arglist__46840);
arglist__46840 = cljs.core.next(arglist__46840);
var y = cljs.core.first(arglist__46840);
var more = cljs.core.rest(arglist__46840);
return G__46836__delegate(x,y,more);
});
...
var G__46842 = null;
if (arguments.length > 2) {
var G__46843__i = 0, G__46843__a = new Array(arguments.length -  2);
while (G__46843__i < G__46843__a.length) {G__46843__a[G__46843__i] = arguments[G__46843__i + 2]; ++G__46843__i;}
G__46842 = new cljs.core.IndexedSeq(G__46843__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46842);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46700__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46701 = u(y);
var map__46701__$1 = cljs.core.__destructure_map(map__46701);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46701__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__46851__delegate = function (x,y,more){
...
var G__46851 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46853__i = 0, G__46853__a = new Array(arguments.length -  2);
while (G__46853__i < G__46853__a.length) {G__46853__a[G__46853__i] = arguments[G__46853__i + 2]; ++G__46853__i;}
  more = new cljs.core.IndexedSeq(G__46853__a,0,null);
} 
return G__46851__delegate.call(this,x,y,more);};
G__46851.cljs$lang$maxFixedArity = 2;
G__46851.cljs$lang$applyTo = (function (arglist__46854){
var x = cljs.core.first(arglist__46854);
arglist__46854 = cljs.core.next(arglist__46854);
var y = cljs.core.first(arglist__46854);
var more = cljs.core.rest(arglist__46854);
return G__46851__delegate(x,y,more);
});
G__46851.cljs$core$IFn$_invoke$arity$variadic = G__46851__delegate;
return G__46851;
})()
;
...
var G__46855 = null;
if (arguments.length > 2) {
var G__46856__i = 0, G__46856__a = new Array(arguments.length -  2);
while (G__46856__i < G__46856__a.length) {G__46856__a[G__46856__i] = arguments[G__46856__i + 2]; ++G__46856__i;}
G__46855 = new cljs.core.IndexedSeq(G__46856__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46855);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
