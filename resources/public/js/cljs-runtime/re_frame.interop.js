...
return [(function (){var pred__45143 = cljs.core.instance_QMARK_;
var expr__45144 = reactive_val;
if(cljs.core.truth_((pred__45143.cljs$core$IFn$_invoke$arity$2 ? pred__45143.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45144) : pred__45143.call(null,reagent.ratom.RAtom,expr__45144)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45143.cljs$core$IFn$_invoke$arity$2 ? pred__45143.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45144) : pred__45143.call(null,reagent.ratom.RCursor,expr__45144)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45143.cljs$core$IFn$_invoke$arity$2 ? pred__45143.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45144) : pred__45143.call(null,reagent.ratom.Reaction,expr__45144)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45143.cljs$core$IFn$_invoke$arity$2 ? pred__45143.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45144) : pred__45143.call(null,reagent.ratom.Track,expr__45144)))){
return "tr";
} else {
return "other";
}
