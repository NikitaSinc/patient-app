...
var G__47443 = request;
var G__47444 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__47443,G__47444) : ajax.formats.get_format.call(null,G__47443,G__47444));
} else {
...
return cljs.core.some((function (p1__47449_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__47449_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__47451){
var map__47452 = p__47451;
var map__47452__$1 = cljs.core.__destructure_map(map__47452);
var request = map__47452__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47452__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__47459 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__47459.cljs$core$IFn$_invoke$arity$1 ? fexpr__47459.cljs$core$IFn$_invoke$arity$1(response) : fexpr__47459.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__47466){
var map__47467 = p__47466;
var map__47467__$1 = cljs.core.__destructure_map(map__47467);
var request = map__47467__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47467__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__47461_SHARP_){
return ajax.formats.get_accept_entries(request,p1__47461_SHARP_);
